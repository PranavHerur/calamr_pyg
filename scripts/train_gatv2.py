#!/usr/bin/env python3
"""GATv2 (improved Graph Attention Network) training script."""

import argparse

from calamr_pyg.models import GATv2
...
def exec(
    ...
    seed: int = 42,
    output_dir: str = "results/gatv2",
    verbose: bool = True,
) -> dict:
    """Train and evaluate GATv2 model."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GATv2")
    ...
    parser.add_argument("--output_dir", type=str, default="results/gatv2")
