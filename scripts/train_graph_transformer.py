#!/usr/bin/env python3
"""
Graph Transformer training for medical hallucination detection.
Uses TransformerConv with edge features for attention-based message passing.
"""
...
def exec(
    ...
    seed: int = 42,
    output_dir: str = "results/graph_transformer",
    verbose: bool = True,
) -> dict:
    """Train and evaluate GraphTransformer model."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="results/graph_transformer")
