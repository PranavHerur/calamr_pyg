#!/usr/bin/env python3
"""GCN2 (GCNII - GCN with Initial residual and Identity mapping) training script."""

import argparse

from calamr_pyg.models import GCN2
...
def exec(
    ...
    seed: int = 42,
    output_dir: str = "results/gcn2",
    verbose: bool = True,
) -> dict:
    """Train and evaluate GCN2 model."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="GCN2")
    ...
    parser.add_argument("--output_dir", type=str, default="results/gcn2")
