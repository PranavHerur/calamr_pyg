...
from calamr_pyg.models import GraphSAGE
...
if __name__ == "__main__":
    ...
    parser.add_argument("--aggregator", default="mean", choices=["mean", "max"])
    ...
    parser.add_argument("--output_dir", type=str, default="results/sage")
