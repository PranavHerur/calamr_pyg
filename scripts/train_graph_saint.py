#!/usr/bin/env python3
"""GraphSAINT (sampling-based GNN) training script."""

import argparse

from calamr_pyg.models import GraphSAINT
...
def exec(
    ...
    seed: int = 42,
    output_dir: str = "results/graph_saint",
    verbose: bool = True,
) -> dict:
    """Train and evaluate GraphSAINT model."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="results/graph_saint")
