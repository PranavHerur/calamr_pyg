#!/usr/bin/env python3
"""APPNP (Approximate Personalized Propagation) training script."""

import argparse

from calamr_pyg.models import APPNP
...
def exec(
    ...
    seed: int = 42,
    output_dir: str = "results/appnp",
    verbose: bool = True,
) -> dict:
    """Train and evaluate APPNP model."""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output_dir", type=str, default="results/appnp")
